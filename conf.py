...
BLOG_TITLE = "Ushichka"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://ushichka.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://example.com/"
BLOG_EMAIL = "thejasvib@gmail.com"
BLOG_DESCRIPTION = "Details, history and updates on Project Ushichka"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ("/pages/history-of-project-ushichka/","History"),
        ("/pages/associated-code/", "Associated Code"),
        ("/blog/","Technical Blog"),
